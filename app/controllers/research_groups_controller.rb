class ResearchGroupsController < ApplicationController
  ...
  private
    ...
    def research_group_params
      params.require(:research_group).permit(:title, :leader_id, :vice_leader_id, :area, :sub_area, :date_update, :description, :justification, :institutions, :infraestructure, :laboratories, :status)
    end
end
